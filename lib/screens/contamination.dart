...
class Contamination extends StatefulWidget {
  const Contamination({super.key});

  @override
  State<Contamination> createState() => _ContaminationState();
}

class _ContaminationState extends State<Contamination> {
  final TextEditingController nameController = TextEditingController();
  bool isFieldShow = false;
  List<QuestionModel> questions = [
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Food stored properly and at standard locations?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Food utensils in used are stored properly?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Cross Contamination must not be observed?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Food packages and cans in good condition, damaged products are segregated?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Utensil/equipment/contact surfaces in good repair?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'Potential Cross-contamination: Conditions must not exist that could lead to cross-contamination?'),
  ];
  File? imageFile;
  getFromCamera() async {
