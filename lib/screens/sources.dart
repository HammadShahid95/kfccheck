...
class _SourcesState extends State<Sources> {
  ...
  List<QuestionModel> questions = [
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Only approved ingredients or foods evident. (FS-Critical)?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Only approved menu items sold?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Only approved equipment and smallwares in use'),
  ];
  getFromCamera() async {
