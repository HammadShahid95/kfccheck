                                  ...
                                  children: [
                                    const Padding(
                                      ...
                                      child: Text('Is the thermometer calibrated?',
                                          style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: Black, fontStyle: FontStyle.normal)),
                                    ),
                                    Row(
                                      children: [
                                        Theme(
                                    ...
                                    Visibility(
                                        visible: isFieldShow,
                                        child:
                                            const Text('Calibrate now!', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: green)))
                                  ],
                                ),
                              ),
                            ),
                ...
                child: InkWell(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: isFieldShow ? const Color.fromRGBO(142, 145, 140, 0.6) : kala),
                    child: Center(
                        child: Text('Submit', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: isFieldShow ? white : Green))),
                  ),
                  onTap: () {
                    isFieldShow ? Container() : Navigator.push(context, MaterialPageRoute(builder: (context) => Done()));
                  },
                ),
              ),
