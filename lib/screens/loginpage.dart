            ...
            child:Column(
              children: [
               ...
               const Padding(
                  ...
                  child: Text('Welcome Back!',style: TextStyle(fontSize: 28,fontWeight: FontWeight.w500,color: kBoldColor),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children:const [
                        ...
                        Text('Log In as Admin',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: DBlack),)
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children:const [
                        ...
                        Text('Log In as Team Member',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: DBlack),)
                      ],
                    ),
                  ),
                ),
