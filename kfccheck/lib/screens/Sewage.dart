...
class Sewage extends StatefulWidget {
  const Sewage({super.key});

  @override
  State<Sewage> createState() => _SewageState();
}

class _SewageState extends State<Sewage> {
  final TextEditingController nameController = TextEditingController();
bool isFieldShow = false;
  List<QuestionModel> questions = [
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Hot water available at 3 compartment sink .(FS-Critical)?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Back flow prevention devices present at all sinks?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Minimum of one functioning toilet available in the facility?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'All plumbing in good repair?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Grease/sink traps or drains not clogged and functioning properly?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Mop sink must be clean, not clogged, functioning properly?'),
  ];
  File? imageFile;
  getFromCamera() async {
