...
class _TempratureState extends State<Temprature> {
  ...
  List<QuestionModel> questions = [
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Calibrated thermometer is available for use. (FS-Critical)?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Cold Potentially Hazardous Foods must be held < 5°C. (FS-Critical)?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Chicken in walk-in is >  1ºC and < 5ºC and within authorized use-by date?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Hot Potentially Hazardous Foods must be held >60°C. (FS-Critical)?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'All products must be cooked to the proper internal cooking temperature per brand standard. (FS-Critical)?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'All  products must not be expired, must be held correctly and have hold time recorded per brand standards?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'Spoiled (potentially hazardous) foods / ingredients are not in use and not for sale. (FS-Critical)?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'All ingredients are within shelf life and rotated properly?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Frozen foods are thawed correctly and held correctly after thawing?'),
  ];
  File? imageFile;
  getFromCamera() async {
