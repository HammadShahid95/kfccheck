...
class _Admin extends State<Admin> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title:const Text("Are you sure you want to sign out?",textAlign: TextAlign.center,),
      actions: [
        Row(
          children: [
            Expanded(
              child: GestureDetector(
                child: Container(
                  ...
                  child:const Center(child: Text('Cancel',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: white),)),
                ),
                onTap: (){
            ...
            Expanded(
              child: GestureDetector(
                child: Container(
                  ...
                  child:const Center(child: Text('Sign Out',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Dgreen),)),
                ),
                onTap: (){
                      ...
                      children: [
                        ...
                        GestureDetector(
                          child: Container(
                            ...
                            child:const Center(child: Text('A',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: Color.fromRGBO(51,51,51,1)),)),
                          ),
                          onTap: (){
                        ...
                        child: BottomNavigationBar(
                          ...
                          items: [
                            BottomNavigationBarItem(
                              icon: InkWell(child:const Icon(Icons.warning_amber,color: Black,size: 30,),
                                onTap: () {
                                  Navigator.push(
                            ...
                            BottomNavigationBarItem(
                              icon: InkWell(child:const ImageIcon(AssetImage('asset/actions.png'),color: Black,size: 30,),
                              onTap: (){
                            ...
                            BottomNavigationBarItem(
                              icon: InkWell(child:const ImageIcon(AssetImage('asset/anomalies.png'),color: Black,size: 30,),
                              onTap: (){
