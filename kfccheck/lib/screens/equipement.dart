...
bool isFieldShow = false;
  List<QuestionModel> questions = [
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Cold holding equipment temperature meets standard?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'Cold holding and storage equipment is functioning properly and needs no repair?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'Hot holding and storage equipment is functioning properly and needs no repair?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'],
        comments: '',
        question: 'Three-compartment sink, prep sink is functioning properly and needs no repair?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'Hot holding and storage temperature meets standard?'),
    QuestionModel(
        answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'All other equipment in use is functioning properly and needs no repair?'),
    QuestionModel(answers: ['Yes', 'No', 'N/A', 'N/O'], comments: '', question: 'All hand wash sinks must be provided with water dispensed ± 38°C?'),
  ];
  File? imageFile;
  getFromCamera() async {
