              ...
              Stack(
                  children:[ Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          InkWell(child:const Icon(Icons.arrow_back_ios,color: white),
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>Admin()));
                          },
                          ),
                         const Text('Report Emergency',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w500,color: Dgreen),)
                        ],
                      ),
                    ),
                  ),
